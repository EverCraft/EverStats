...
public class EDeathStatsUserEvent extends EStatsUserEvent implements StatsUserEvent.Death {	

	private final Optional<Entity> killer;

    public EDeathStatsUserEvent(EPlayer victim, Entity killer, DamageType damage, Long time, Cause cause) {
    	super(Type.DEATH, victim, damage, time, cause);
    	this.killer = Optional.of(killer);
    }
    
    public EDeathStatsUserEvent(EPlayer victim, DamageType damage, Long time, Cause cause) {
    	super(Type.DEATH, victim, damage, time, cause);
